...
class PaginasControllerTest < ActionController::TestCase
  ...
  test "should create pagina" do
    assert_difference('Pagina.count') do
      post :create, pagina: { contenido: @pagina.contenido, created_at: @pagina.created_at, modified_at: @pagina.modified_at, titulo: @pagina.titulo }
    end
  ...
  test "should update pagina" do
    patch :update, id: @pagina, pagina: { contenido: @pagina.contenido, created_at: @pagina.created_at, modified_at: @pagina.modified_at, titulo: @pagina.titulo }
    assert_redirected_to pagina_path(assigns(:pagina))
  end
